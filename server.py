...
def model():
   if request.method == 'POST':
      ...
      CLASSES = ["춥다", "덥다", "먹구름", "바람", "비", "온도", "장마", "햇빛", "싫다", "좋다", "양산", "체온", "하늘", "강풍", "따뜻하다", "홍수", "예정",
                 "사계절", "눈", "뙤약볕","감기", "에어컨", "체감", "경고", "찻길", "출근", "강", "파도", "어젯밤", "방금", "어떻게", "자정", "아까", "최대", "최소", "평일",
                 "깜깜하다", "틀림없다", "매일매일", "혹시", "들어맞다", "사라지다", "오래도록", "찰나", "이미", "순식간", "모르다", "불가능", "충분", "불안", "당황", "원하다", "무섭다", "빠르다", "즐겁다",
                 "마지막", "오다", "깨끗하다", "행복", "떨다", "조심", "변덕", "망설이다", "희망", "힘들다", "화나다", "놀라다", "사람", "우울", "빨리", "못하다", "시원하다", "기억", "무지개", "불신", "대략",
